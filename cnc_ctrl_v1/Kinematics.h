    ...
    class Kinematics{
        public:
            ...
            //geometry
            float l             = 324.0;                               //horizontal distance between sled attach points
            float s             = 140.0;                               //vertical distance between sled attach points and bit
            ...
            float D             = 3048;                              //distance between sprocket centers
